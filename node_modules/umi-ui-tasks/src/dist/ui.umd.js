(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('react'), require('antd'), require('react-dom')) :
  typeof define === 'function' && define.amd ? define(['react', 'antd', 'react-dom'], factory) :
  (global = global || self, global.tasks = factory(global.React$1, global.antd, global.reactDom));
}(this, function (React$1, antd, reactDom) { 'use strict';
  ...
  */
  ...
  var DeleteOutlineSvg = unwrapExports(DeleteOutline_1);
  ...
  var EnterOutline_1 = createCommonjsModule(function (module, exports) {
  Object.defineProperty(exports, "__esModule", { value: true });
  var EnterOutline = {
      name: 'enter',
      theme: 'outline',
  ...
  var EnterOutlineSvg = unwrapExports(EnterOutline_1);

  // GENERATE BY ./scripts/generateIcons.js

  var Enter = function Enter(props) {
    return React$1__default.createElement(Icon, Object.assign({}, props, {
      icon: EnterOutlineSvg
    }));
  };
  ...
  */
  ...
  var createResizeDetector = _interopDefault(elementResizeDetector);
  ...
  var isShallowEqual = _interopDefault(shallowequal);
  ...
  function () {
    ...
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee(taskType) {
      var args,
          env,
          result,
          errMsg,
  ...
  function () {
    ...
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee2(taskType) {
  ...
  function () {
    ...
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee3(taskType) {
      var log,
          dbPath,
          _args3 = arguments;
  ...
  function () {
    ...
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee6(taskType) {
  ...
  function initTerminal() {
    ...
    terminal.loadAddon(new xtermAddonWebLinks_1());
    return terminal;
  }

  var TASKS = [TaskType.BUILD, TaskType.DEV, TaskType.LINT, TaskType.TEST, TaskType.INSTALL];
  var TERMINAL_MAPS = {};
  TASKS.forEach(function (taskType) {
    TERMINAL_MAPS[taskType] = initTerminal();
  });

  var getTerminalIns = function getTerminalIns(taskType) {
    return TERMINAL_MAPS[taskType];
  };
  ...
  var useTerminal = function useTerminal(_ref) {
  ...
  var css$1 = ".index-module_wrapper__3T5Iw {\n  background-color: #15171c;\n  border-radius: 2px;\n  padding: 12px 16px;\n  font-size: 14px;\n  color: rgba(255, 255, 255, 0.65);\n  line-height: 22px;\n  height: 100%;\n}\n.index-module_titleWrapper__3VnWc {\n  margin-bottom: 8px;\n}\n.index-module_actionGroup__1OHJE {\n  text-align: right;\n}\n.index-module_actionGroup__1OHJE > i {\n  margin-left: 16px;\n}\n.index-module_logContainer__3TKyW {\n  padding: 0;\n  height: 100%;\n  min-width: 600px;\n}\n.index-module_icon__FNyoQ {\n  margin-left: 16px;\n}\n";
  var styles$1 = {"wrapper":"index-module_wrapper__3T5Iw","titleWrapper":"index-module_titleWrapper__3VnWc","actionGroup":"index-module_actionGroup__1OHJE","logContainer":"index-module_logContainer__3TKyW","icon":"index-module_icon__FNyoQ"};
  styleInject(css$1);

  var TerminalComponent = function TerminalComponent(_ref) {
    var terminal = _ref.terminal,
        log = _ref.log,
        ...
        api = _ref.api;
    var intl = api.intl;
    var domContainer = React$1.useRef();
    ...
    }, [log]); // mount or updated

    var prevSize = usePrevious(size);
    React$1.useEffect(function () {
      if (prevSize) {
    ...
    }, React$1__default.createElement(antd.Row, {
      className: styles$1.titleWrapper
    }, React$1__default.createElement(antd.Col, {
      span: 8,
      className: styles$1.formmatGroup
    }, intl({
      id: 'org.umi.ui.tasks.log.title'
    })), React$1__default.createElement(antd.Col, {
      span: 4,
      offset: 12,
      className: styles$1.actionGroup
    }, React$1__default.createElement("span", {
      className: styles$1.icon
    }, React$1__default.createElement(antd.Tooltip, {
      title: intl({
        id: 'org.umi.ui.tasks.terminal.clear'
      })
    }, React$1__default.createElement(Delete, {
      onClick: clear
    }))), React$1__default.createElement("span", {
      className: styles$1.icon
    }, React$1__default.createElement(antd.Tooltip, {
      title: intl({
        id: 'org.umi.ui.tasks.terminal.bottom'
      })
    }, React$1__default.createElement(Enter, {
      onClick: toBottom
    }))))), React$1__default.createElement("div", {
      ref: domContainer,
      className: styles$1.logContainer
    }));
  };
  ...
  var model = {
    ...
    effects: {
      ...
      init:
      /*#__PURE__*/
      regeneratorRuntime.mark(function init(_ref, _ref2) {
      ...
      exec:
      /*#__PURE__*/
      regeneratorRuntime.mark(function exec(_ref4, _ref5) {
      ...
      cancel:
      /*#__PURE__*/
      regeneratorRuntime.mark(function cancel(_ref6, _ref7) {
      ...
      getTaskDetail:
      /*#__PURE__*/
      regeneratorRuntime.mark(function getTaskDetail$1(_ref8, _ref9) {
    ...
    reducers: {
      initCurrentProjectState: function initCurrentProjectState(state, _ref10) {
      ...
      updateTaskDetail: function updateTaskDetail(state, _ref11) {
      ...
      updateWebpackStats: function updateWebpackStats(state, _ref12) {
        ...
        history.listen(function (_ref14) {
          ...
          if (pathname === '/tasks') {
            ...
            listenRemote({
              ...
              onMessage: function onMessage(_ref15) {
                var detail = _ref15.detail,
                    taskType = _ref15.taskType,
                    cwd = _ref15.cwd;
                // 更新 state 数据
                dispatch({
            ...
            listenRemote({
              ...
              onMessage: function onMessage(_ref16) {
                var _ref16$log = _ref16.log,
                    log = _ref16$log === void 0 ? '' : _ref16$log,
  ...
  var css$2 = ".index-module_container__15Y2D {\n  color: #000;\n  position: fixed;\n  padding: 5px 10px;\n  border-radius: 4px;\n  background: #fff;\n  border: 1px solid #aaa;\n  opacity: 0.7;\n  white-space: nowrap;\n  visibility: visible;\n  transition: opacity 0.2s ease, visibility 0.2s ease;\n}\n.index-module_hidden__3RgCI {\n  opacity: 0;\n  visibility: hidden;\n}\n";
  var styles$2 = {"container":"index-module_container__15Y2D","hidden":"index-module_hidden__3RgCI"};
  styleInject(css$2);
  ...
  function (_React$Component) {
    ...
    _createClass(Tooltip, [{
      ...
      value: function render() {
        ...
        var className = classnames((_cls = {}, _defineProperty(_cls, styles$2.container, true), _defineProperty(_cls, styles$2.hidden, !visible), _cls));
        return React$1__default.createElement("div", {
          ref: this.saveNode,
          className: className,
          style: this.getStyle()
    ...
    _createClass(AnalyzeComponent, [{
      ...
      value: function render() {
        ...
        return React$1__default.createElement("div", {
          ...
          className: styles$3.iframeContainer
        }, showReloadFlag ? React$1__default.createElement("div", {
          className: styles$3.reload,
          onClick: this.reloadIframe
        }, React$1__default.createElement(Reload, null)) : null, React$1__default.createElement("iframe", {
          ref: this.iframeRef,
          className: styles$3.iframe,
          src: src
        })) : React$1__default.createElement(React$1__default.Fragment, null, React$1__default.createElement(Treemap, {
          className: styles$3.map,
          ref: this.saveRef,
  ...
  var SizeMe$1 = reactSizeme.SizeMe;
  var taskType = TaskType.DEV;
  ...
  var DevComponent = function DevComponent(_ref) {
    ...
    React$1.useEffect(function () {
      ...
      return function () {
        form.resetFields();
        var terminal = getTerminalIns(taskType);
    ...
    }, isTaskRunning ? React$1__default.createElement(React$1__default.Fragment, null, React$1__default.createElement(Pause, null), React$1__default.createElement("span", {
      className: styles.runningText
    }, ' ', intl({
      id: 'org.umi.ui.tasks.dev.cancel'
    }))) : React$1__default.createElement(React$1__default.Fragment, null, React$1__default.createElement(CaretRight, null), React$1__default.createElement("span", {
      className: styles.runningText
    }, ' ', intl({
    ...
    }, React$1__default.createElement(SizeMe$1, {
      monitorWidth: true,
      monitorHeight: true
    }, function (_ref4) {
      var size = _ref4.size;
      return view === 'log' ? React$1__default.createElement(TerminalComponent, {
        api: api,
        size: size,
  ...
  var SizeMe$2 = reactSizeme.SizeMe;
  var taskType$1 = TaskType.BUILD;
  ...
  var BuildComponent = function BuildComponent(_ref) {
    ...
    React$1.useEffect(function () {
      ...
      return function () {
        form.resetFields();
        var terminal = getTerminalIns(taskType$1);
        terminal && terminal.clear();
      };
    }, [init, view]);
    ...
    function _cancelBuild() {
      _cancelBuild = _asyncToGenerator(
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee2() {
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
    ...
    return React$1__default.createElement(React$1__default.Fragment, null, React$1__default.createElement("h1", {
      ...
      className: styles.logContainer
    }, React$1__default.createElement(SizeMe$2, {
      monitorWidth: true,
      monitorHeight: true
    }, function (_ref3) {
      var size = _ref3.size;
      return view === 'log' ? React$1__default.createElement(TerminalComponent, {
        api: api,
        size: size,
        terminal: getTerminalIns(taskType$1),
        log: log,
        onClear: function onClear() {
          clearLog(taskType$1);
        }
  ...
  var SizeMe$3 = reactSizeme.SizeMe;
  var taskType$2 = TaskType.LINT;
  ...
  var LintComponent = function LintComponent(_ref) {
    ...
    React$1.useEffect(function () {
      ...
      return function () {
        var terminal = getTerminalIns(taskType$2);
        terminal && terminal.clear();
      };
    }, [init]);
    ...
    return React$1__default.createElement(React$1__default.Fragment, null, React$1__default.createElement("h1", {
      ...
      className: styles.logContainer
    }, React$1__default.createElement(SizeMe$3, {
      monitorWidth: true,
      monitorHeight: true
    }, function (_ref3) {
      var size = _ref3.size;
      return React$1__default.createElement(TerminalComponent, {
        api: api,
        size: size,
        terminal: getTerminalIns(taskType$2),
        log: log,
        onClear: function onClear() {
          clearLog(taskType$2);
        }
  ...
  var SizeMe$4 = reactSizeme.SizeMe;
  var taskType$3 = TaskType.TEST;
  ...
  var TestComponent = function TestComponent(_ref) {
    ...
    React$1.useEffect(function () {
      ...
      return function () {
        var terminal = getTerminalIns(taskType$3);
        terminal && terminal.clear();
      };
    }, [init]);
    ...
    return React$1__default.createElement(React$1__default.Fragment, null, React$1__default.createElement("h1", {
      ...
      className: styles.logContainer
    }, React$1__default.createElement(SizeMe$4, {
      monitorWidth: true,
      monitorHeight: true
    }, function (_ref3) {
      var size = _ref3.size;
      return React$1__default.createElement(TerminalComponent, {
        api: api,
        size: size,
        terminal: getTerminalIns(taskType$3),
        log: log,
        onClear: function onClear() {
          clearLog(taskType$3);
        }
  ...
  var SizeMe$5 = reactSizeme.SizeMe;
  var taskType$4 = TaskType.INSTALL;
  ...
  var InstallComponent = function InstallComponent(_ref) {
    ...
    React$1.useEffect(function () {
      return function () {
        form.resetFields();
        var terminal = getTerminalIns(taskType$4);
        terminal && terminal.clear();
      };
    }, []);
    ...
    function _install() {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee2(npmClient) {
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
    ...
    function _cancelInstall() {
      _cancelInstall = _asyncToGenerator(
      /*#__PURE__*/
    ...
    return React$1__default.createElement(React$1__default.Fragment, null, React$1__default.createElement("h1", {
      ...
      className: styles.logContainer
    }, React$1__default.createElement(SizeMe$5, {
      monitorWidth: true,
      monitorHeight: true
    }, function (_ref5) {
      var size = _ref5.size;
      return React$1__default.createElement(TerminalComponent, {
        api: api,
        size: size,
        terminal: getTerminalIns(taskType$4),
        log: log,
        onClear: function onClear() {
          clearLog(taskType$4);
        }
  ...
  var _orgUmiUiTasksTit;

  var enUS = (_orgUmiUiTasksTit = {
