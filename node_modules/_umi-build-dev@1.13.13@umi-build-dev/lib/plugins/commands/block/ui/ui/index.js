...
var BlocksViewer = function BlocksViewer(props) {
  ...
  var _useState9 = (0, _react.useState)(query.type || 'block'),
      _useState10 = _slicedToArray(_useState9, 2),
      type = _useState10[0],
      setType = _useState10[1];

  var _useState11 = (0, _react.useState)(query.resource ? {
    id: query.resource
  } : null),
  ...
  (0, _react.useEffect)(function () {
    ...
    if (api.setActionPanel) {
      api.setActionPanel(function () {
        ...
        }, _react.default.createElement(_icons.Reload, null))), _react.default.createElement(_antd.Tooltip, {
          title: intl({
        ...
        }, _react.default.createElement(_icons.Plus, null)))];
      });
    }
  }, []);
  ...
  return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement("div", {
    className: "".concat(_indexModule.default.container, " ").concat(isMini && _indexModule.default.min),
    id: "block-list-view"
  }, current ? _react.default.createElement("div", {
    className: _indexModule.default.blockList
  }, _react.default.createElement(_antd.Tabs, {
    className: _indexModule.default.tabs,
    activeKey: type,
    ...
    className: _indexModule.default.loading
